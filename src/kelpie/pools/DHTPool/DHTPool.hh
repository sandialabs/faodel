...
public:
  ...
  explicit DHTPool(const faodel::ResourceURL &pool_url);
  ~DHTPool() override = default;

  //PoolBase functions
  rc_t Publish(const Key &key, const fn_publish_callback_t &callback) override;  //Lookup a local k/v and publish it
