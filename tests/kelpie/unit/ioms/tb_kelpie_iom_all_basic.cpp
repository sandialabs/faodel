...
TYPED_TEST_P(IomSimple, write_direct) {
  ...
  internal::IomBase *iom = new TypeParam("myiom", {{"path",path}});
...
TYPED_TEST_P(IomSimple, iom_registry) {
  ...
  registry.RegisterIom(TypeParam::type_str, "myiom1", {{"path",p1}} );
  registry.RegisterIom(TypeParam::type_str, "myiom2", {{"path",p2}} );

  registry.start(); //Make the next one go in mutex-controlled section
  registry.RegisterIom(TypeParam::type_str, "myiom3", {{"path",p3}} );
