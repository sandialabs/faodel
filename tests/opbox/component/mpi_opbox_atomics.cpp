...
protected:
  ...
  public:
      atomics_callback(OpboxAtomicsTest &p, DataObject ldo, opbox::net::peer_t *peer): parent_(p),ldo_(ldo),peer_(peer) {}
  ...
  public:
      ...
      void CompareSwap(opbox::net::peer_ptr_t peer, opbox::net::NetBufferRemote *nbr, int64_t operand1, int64_t operand2) {
          opbox::net::Atomic(
              peer,
              opbox::net::AtomicOp::FetchAdd,
              parent_.atomics_ldo,
...
TEST_F(OpboxAtomicsTest, start1) {
    ...
    if(mpi_rank == root_rank){
        ...
        memset(atomics_target.GetDataPtr(), 1, atomics_target.GetDataSize());
