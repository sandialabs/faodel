...
public:
    OpBenchmarkGet(opbox::net::peer_ptr_t dst, uint32_t size, uint32_t count, uint32_t max_inflight);
    OpBenchmarkGet(op_create_as_target_t t);
    ~OpBenchmarkGet();
